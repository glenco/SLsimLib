...
PosType Grid::magnification(double sblimit) const {
  
  return LensedFlux(sblimit)/UnlensedFlux(sblimit);
...
PosType Grid::UnlensedFlux(double sblimit) const{
...
PosType Grid::LensedFlux(double sblimit) const{
