...
public:
	LensHaloPowerLaw();
  LensHaloPowerLaw(float my_mass,float my_Rmax,PosType my_zlens,PosType my_beta,float my_fratio,float my_pa, int my_stars_N, EllipMethod my_ellip_method=Pseudo);
