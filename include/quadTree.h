...
void TreeQuadParticles<PType>::walkTree_iter(
  ...
  PosType xcm[2],rcm2cell,rcm2,tmp,boxarea;
  IndexType i;
  ...
  do{
    ...
    if((*treeit)->nparticles > 0)
    {
      ...
      boxarea = ((*treeit)->boundary_p2[0]-(*treeit)->boundary_p1[0])*((*treeit)->boundary_p2[0]-(*treeit)->boundary_p1[0]);
      
      if( rcm2cell < ((*treeit)->rcrit_angle)*((*treeit)->rcrit_angle) || rcm2cell < 5.83*boxarea)
      {
