      ...
      if(flag_field_gal_on){
        ...
        float pa = 2*pi*ran2(seed);  //TODO: This is a kluge.
          ...
          case pl_gal:
            ...
            field_halos.push_back(new LensHaloPowerLaw(mass*field_galaxy_mass_fraction,rmaxNSIE(sigma, mass*field_galaxy_mass_fraction, fratio, 0.0),z,field_int_prof_gal_slope,fratio,pa+pi/2.,0,Pseudo));
